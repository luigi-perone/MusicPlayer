...
**Allora** nell’interfaccia deve apparire un messaggio (es. "La tua libreria è vuota. Aggiungi il tuo primo brano!").
...
**Allora** il sistema non elimina subito il brano, ma mostra un messaggio di conferma (es. "Sei sicuro di voler eliminare definitivamente questa traccia?").
...
**Allora** il sistema mostra un messaggio di conferma (es. "Sei sicuro di voler eliminare questa playlist?").
...
**Allora** ogni brano mostra il titolo, l'artista, l'album, la durata e la posizione numerica all'interno della playlist (es. 1, 2, 3...).
...
**Allora** viene visualizzato un messaggio (es. "Questa playlist è vuota") associato al pulsante per aggiungere brani.
...
**Quando** fa doppio clic sulla riga di una traccia o clicca sul pulsante "Play" ad essa associato,
...
* **Dato** che l'utente sta ascoltando una playlist e la traccia corrente non è l'ultima della lista,
...
**Quando** clicca sul pulsante "Successivo" o la traccia termina,
...
**Quando** clicca una volta sul pulsante "Ripeti" (Loop) nel player globale,
...
* **Dato** che un brano è in esecuzione nel momento in cui viene attivato lo Shuffle,
...
**Quando** rimuove una traccia posizionata dopo quella attualmente in riproduzione,
...
**Allora** il sistema crea automaticamente una nuova playlist nominandola di default con il nome del genere stesso (es. "Playlist Rock"), inserendovi all'interno tutti i brani individuati.
...
**Allora** il sistema annulla la creazione e mostra un messaggio informativo (es. "Nessun brano trovato per questo genere nella tua libreria").
...
**Allora** il sistema crea automaticamente una nuova playlist nominandola di default con l'anno di riferimento (es. "I brani del 1999") con all'interno tutte le tracce filtrate.
...
**Allora** il sistema impedisce la creazione della playlist e mostra una messaggio di avviso (es. "Nessun brano trovato per l'anno inserito").
...
**Allora** il sistema rimuove l'associazione e fa scomparire l'icona vicino al titolo.
...
**Allora** il sistema non permette la creazione della playlist e mostra un messaggio (es. "Nessun brano corrisponde alla combinazione di tag selezionata").
